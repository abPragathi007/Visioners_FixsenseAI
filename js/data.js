    ...
    State.vehicles = [
      {
        ...
        odometer: 18500,
        lastDiagnosis: { score: 78, color: 'amber', date: '2026-04-08' },
      },
      {
        id: 'v2',
        type: 'scooter',
        ...
        odometer: 12000,
        lastDiagnosis: { score: 91, color: 'green', date: '2026-04-05' },
      },
      {
        id: 'v3',
        type: 'auto',
        ...
        odometer: 45000,
        lastDiagnosis: { score: 45, color: 'red', date: '2026-04-10' },
      },
    ];
    State.diagnoseHistory = [
      { id: 'h1', vehicleId: 'v1', vehicleName: 'My Splendor', vehicleType: 'bike', score: 78, color: 'amber', date: '2026-04-08', issues: ['Low engine oil', 'Air filter check'] },
      { id: 'h2', vehicleId: 'v2', vehicleName: 'Activa', vehicleType: 'scooter', score: 91, color: 'green', date: '2026-04-05', issues: [] },
      { id: 'h3', vehicleId: 'v3', vehicleName: 'Auto #1', vehicleType: 'auto', score: 45, color: 'red', date: '2026-04-10', issues: ['Engine overheating', 'Dirty oil', 'Weak battery'] },
      { id: 'h4', vehicleId: 'v1', vehicleName: 'My Splendor', vehicleType: 'bike', score: 65, color: 'amber', date: '2026-03-20', issues: ['Km service overdue'] },
      { id: 'h5', vehicleId: 'v3', vehicleName: 'Auto #1', vehicleType: 'auto', score: 55, color: 'amber', date: '2026-03-12', issues: ['Low CNG pressure', 'High temp'] },
    ];
  }
}
